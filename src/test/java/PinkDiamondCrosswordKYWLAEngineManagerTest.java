...
public class PinkDiamondCrosswordKYWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PinkDiamondCrosswordKYWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordKYIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordKYIW/InitOutcome.xml").getDocumentElement();
